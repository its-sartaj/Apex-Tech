    ...
    <div className={`relative w-full overflow-hidden flex items-center justify-center py-6 sm:py-8 select-none ${className}`}>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative flex items-center justify-center">
        <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-white/15 to-transparent relative">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 w-28 sm:w-44 h-[2.5px] bg-gradient-to-r from-transparent via-[#00A09D] via-white to-transparent shadow-[0_0_12px_#017E84,0_0_24px_#714B67] animate-laser-1" />

          {/* Opposite Subtle Counter-Pulse for Organic Rhythm */}
          <div className="absolute top-1/2 -translate-y-1/2 w-20 sm:w-32 h-[1.5px] bg-gradient-to-r from-transparent via-[#9B6C8F] to-transparent shadow-[0_0_10px_#714B67] animate-laser-2" />
        </div>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
          {showBadge && badgeLabel ? (
            ...
            <div className="px-3 py-1 rounded-full bg-[#14101A] border border-[#714B67]/40 shadow-[0_0_15px_rgba(113,75,103,0.4)] flex items-center gap-1.5 backdrop-blur-md cursor-default transition-transform hover:scale-105">
            ...
            <div className="relative flex items-center justify-center">
              {/* Outer Radiant Flare */}
              <div className="absolute w-6 h-6 bg-gradient-to-tr from-[#714B67]/40 to-[#017E84]/40 rounded-full blur-sm animate-pulse" />

              {/* Diamond Node */}
              <div className="w-3.5 h-3.5 rotate-45 rounded-[2px] bg-gradient-to-tr from-[#1E1724] via-[#10141D] to-[#0A0D14] border border-[#00A09D]/70 shadow-[0_0_10px_rgba(1,126,132,0.6)] flex items-center justify-center transition-transform hover:scale-125">
