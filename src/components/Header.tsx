...
export default function Header({ onOpenConsultation }: HeaderProps) {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 text-[15px] font-semibold text-slate-700">
            {['Services', 'Process', 'Work', 'Reviews', 'FAQ', 'Contact'].map((item) => (
              <a
                ...
                className="hover:text-[#714B67] hover:-translate-y-0.5 transition-all py-1 relative group"
              >
                <span>{item}</span>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full text-xs font-bold bg-slate-50 hover:bg-slate-100 text-slate-800 transition-all hover:scale-[1.03] active:scale-[0.97] border border-slate-200"
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#714B67] hover:bg-[#885B7C] text-white text-xs font-bold px-4 py-2.5 rounded-full transition-all hover:scale-[1.03] active:scale-[0.97] shadow-[0_2px_10px_rgba(113,75,103,0.3)] cursor-pointer"
            >
      ...
      {/* Mobile Drawer with pure CSS transition */}
      {mobileMenuOpen && (
        <div
          id="mobile-navigation-menu"
          role="navigation"
          aria-label="Mobile navigation"
          className="md:hidden bg-white border-b border-slate-200 px-5 pt-4 pb-6 space-y-4 shadow-xl overflow-hidden transition-all duration-200 animate-fadeIn"
        >
          ...
          <div className="pt-3 border-t border-slate-100 space-y-2.5">
            ...
            <button
              ...
              className="w-full py-3 bg-[#714B67] hover:bg-[#885B7C] text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-colors shadow-[0_2px_10px_rgba(113,75,103,0.3)] cursor-pointer"
            >
              <span>Start a Project</span>
